        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            },
            {
              ...
              description:
                "Stay compliant with real-time monitoring and alerts.",
            },
            {
              icon: <Users className="w-10 h-10 text-blue-600" />,
              title: "Team Collaboration",
              description:
                "Work together seamlessly with integrated task management.",
            },
          ].map((feature, index) => (
            <motion.div
              key={index}
                  ...
                  <div className="p-6 space-y-4">
                    ...
                    <div className="mb-4 p-3 rounded bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-700 text-blue-800 dark:text-blue-200 text-sm">
                      ...
                      <div className="mt-2 text-xs text-blue-700 dark:text-blue-200">
                        <span className="font-semibold">Note:</span> Use this demo email and password to take a look <br/>at the software without creating an account. This allows <br/> you to explore the features and interface as a guest user.
                      </div>
                    </div>
